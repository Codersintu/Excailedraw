...
export default function RoomForm({setShow}:any) {
  ...
  return (
    <div className="flex justify-center items-center absolute inset-0 z-50 bg-white/40 ">
      <div className="max-w-2xl flex shadow-2xl bg-linear-to-r from-[#2D3844] via-[#62240C] to-[#62240C] px-10 py-10 rounded-2xl">

        <form className="flex flex-col justify-center items-center gap-12" onSubmit={handleSubmit(onSubmit)}>
          <div className="flex justify-between items-center w-full">
            <Pencil className="w-12 h-12 text-[#62240C]" />
            <svg onClick={()=>setShow(false)} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className="w-6 h-6 flex items-end justify-end cursor-pointer text-white" viewBox="0 0 50 50">
          ...
          <div className="text-2xl text-gray-500 font-bold">Name your workspace:</div>
