...
function RoomName({roomName,setShow,show}:{roomName:RoomProp[],setShow:any,show:any}){
  ...
  return(
    ...
    <div className="flex flex-col items-start px-4">
      <h1 className="text-2xl font-bold text-teal-600">EXPLORE CANVAS ROOM ➡️</h1>
      <p className="text-xs font-semibold text-gray-600">Draw Innovative Idea into practical</p>
    </div>
